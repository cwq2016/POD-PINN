...
ist4num=5
ist5num=5
resultsdir="resultsNew_t=0_LossWeight"
...
for ((i5=0; i5<$ist5num; i5++)); do
	...
	ien2=`expr ${ist2} + 1`
        ...
        ien5=`expr ${ist5} + 1`
	sbatch run.sh "python3 Cases_test_t0.py $ist1 $ien1 $ist2 $ien2 $ist3 $ien3 $ist4 $ien4 $ist5 $ien5  ${resultsdir}" "log_${resultsdir}_${ist1}-${ien1}and${ist2}-${ien2}and${ist3}-${ien3}and${ist4}-${ien4}and${ist5}-${ien5}"
#	sleep 1
done
done
done
